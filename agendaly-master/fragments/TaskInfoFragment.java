...
public class TaskInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        status.setText((task.isCheck())
                ? R.string.completed : R.string.uncompleted);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        this.binding.taskInfoEditButton.setOnClickListener(v -> {
            ...
            NavHostFragment.findNavController(this)
                    .navigate(R.id
                            .action_TaskInfoFragment_to_TaskEditFragment, bundle);
        });
    }

    private void deleteCautionMessage() {
        ContextThemeWrapper newContext = new ContextThemeWrapper
                (this.getContext(), R.style.Theme_Agendaly_AlertDialog);
        AlertDialog.Builder alert = new AlertDialog.Builder(newContext);
        alert.setMessage(getString(R.string.caution_text_delete)
